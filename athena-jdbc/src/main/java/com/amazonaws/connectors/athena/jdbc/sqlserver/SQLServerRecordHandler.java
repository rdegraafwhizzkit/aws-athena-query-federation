...
public class SQLServerRecordHandler
        extends JdbcRecordHandler
{
    ...
    {
        this(JDBCUtil.getSingleDatabaseConfigFromEnv(JdbcConnectionFactory.DatabaseEngine.SQLSERVER));
    }
    ...
    public SQLServerRecordHandler(final DatabaseConnectionConfig databaseConnectionConfig)
    {
        this(databaseConnectionConfig, AmazonS3ClientBuilder.defaultClient(), AWSSecretsManagerClientBuilder.defaultClient(), AmazonAthenaClientBuilder.defaultClient(),
                new GenericJdbcConnectionFactory(databaseConnectionConfig, SQLServerMetadataHandler.JDBC_PROPERTIES), new SQLServerQueryStringBuilder(SQLSERVER_QUOTE_CHARACTER));
    }

    @VisibleForTesting
    public SQLServerRecordHandler(final DatabaseConnectionConfig databaseConnectionConfig, final AmazonS3 amazonS3, final AWSSecretsManager secretsManager,
